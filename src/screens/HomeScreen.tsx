      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <AnimatedCard style={styles.grid} delay={130}>
          {quickActions.map(item => (
            ...
            >
              <View
                style={[styles.actionRail, getActionIconStyle(item.tone)]}
              />
              ...
              <View style={styles.actionTopRow}>
                <View
                  style={[styles.actionIcon, getActionIconStyle(item.tone)]}
                >
...
const buildHomeProfile = (
  ...
  const hasPendingReport = Boolean(findNestedValue(homeData, ['pending']));
  const eodMessage =
    getStringValue(homeData, ['message']) ??
  ...
  return {
    alertText: hasPendingReport
      ? eodMessage
      : `Signed in as ${fullName} • Employee ID ${employeeId}`,
