      ...
      */
      ...
      watchId.current = Geolocation.watchPosition(
        (location) => {
          ...
          console.log(`[BillableTracking] AppState: ${AppState.currentState} | LIVE LAT: ${lat}, LIVE LNG: ${lng}`);
        ...
        <AnimatedCard style={styles.projectCard} delay={100}>
          ...
          >
            <View style={styles.projectInfo}>
              ...
              <Text style={[styles.projectText, !selectedProject && styles.placeholder]}>
                {selectedProject?.name || 'Choose a project'}
              </Text>
            </View>
            {!isTracking && <Feather name="chevron-down" size={18} color={theme.colors.muted} />}
          </TouchableOpacity>
        </AnimatedCard>
            ...
            {currentCoords && (
              ...
              >
                <View style={styles.markerWrapper}>
                  ...
                  <View style={[styles.pinTail, { borderTopColor: theme.colors.primary }]} />
          ...
          {selectedPoint && (
            <AnimatedCard style={styles.floatingInfoCard} delay={0}>
              <View style={styles.calloutHeader}>
                ...
                <TouchableOpacity onPress={() => setSelectedPoint(null)} style={styles.closeCalloutBtn}>
              ...
              <View style={styles.calloutStatus}>
                <View style={[styles.statusDot, { backgroundColor: isTracking ? '#10B981' : theme.colors.muted }]} />
                <Text style={styles.statusLabel}>{isTracking ? 'Active Session' : 'Idle'}</Text>
              </View>
            </AnimatedCard>
          )}
        </View>
